...
#   ICESLAB_REF        Branch/tag/sha (default v0.1.6, pinned for alpha)
...
banner() {
  ...
  printf '  v0.1.6  ·  github.com/icecompany-tech/iceslab\n'
  printf '\n'
}
...
ICESLAB_REF=${ICESLAB_REF:-v0.1.6}
...
# maintainer token is compromised, an attacker can re-point v0.1.6 to a
