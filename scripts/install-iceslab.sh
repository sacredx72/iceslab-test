...
#   ICESLAB_REF        Branch/tag/sha (default v0.1.2 — pinned for alpha)
...
banner() {
  ...
  printf '  v0.1.2  ·  github.com/icecompany-tech/iceslab\n'
  printf '\n'
}
...
ICESLAB_REF=${ICESLAB_REF:-v0.1.2}
...
# maintainer token is compromised, an attacker can re-point v0.1.2 to a
